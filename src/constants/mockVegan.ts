export const mockVegan = [
    ...
    {
        id: 5,
        image: '/src/assets/images/menu_img_5.png',
    ...
    {
        id: 7,
        image: '/src/assets/images/menu_img_7.png',
        badgeIcon: '/src/assets/icons/international.svg',
        badgeTitle: 'Национальные',
        badgeColor: 'lime.50',
        favoriteCount: '124',
        ...
        description:
            'Такая картошечка украсит любой семейный обед! Все будут в полном восторге, очень вкусно! Аромат чеснока, хрустящая корочка на картошечке - просто объедение!',
    },
    {
        id: 8,
        image: '/src/assets/images/menu_img_8.png',
        badgeIcon: '/src/assets/icons/international.svg',
        badgeTitle: 'Национальные',
        badgeColor: 'lime.50',
        favoriteCount: '124',
